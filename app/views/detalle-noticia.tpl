...
<small>{{date("Y/m/d H:i:s", $noticia->creado->sec)}}</small>
    <div>
        <i class="button small fa fa-2x fa-twitter"  data-text="{{{substr($noticia->titulo,0, 80)}}}..." data-url="http://corruptos.net/noticia/{{$noticia->uri}}"></i>
        <i class="button small fa fa-2x fa-facebook" data-text="{{{substr($noticia->titulo,0, 80)}}}..." data-url="http://corruptos.net/noticia/{{$noticia->uri}}"></i>
    </div>
